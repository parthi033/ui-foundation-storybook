...
import {
  compile
} from "./chunk-2XSULEEV.js";
import "./chunk-5U36AKDC.js";
import "./chunk-WIOC2PK4.js";
import {
  __commonJS,
  __toESM
} from "./chunk-ORLXCMHX.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-TQBSQBRQ.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-QN3Z67ER.js")).default;
  return {
