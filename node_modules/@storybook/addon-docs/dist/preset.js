import CJS_COMPAT_NODE_URL_eql589jihxo from 'node:url';
import CJS_COMPAT_NODE_PATH_eql589jihxo from 'node:path';
import CJS_COMPAT_NODE_MODULE_eql589jihxo from "node:module";

var __filename = CJS_COMPAT_NODE_URL_eql589jihxo.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_eql589jihxo.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_eql589jihxo.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-ORLXCMHX.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-TQBSQBRQ.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-QN3Z67ER.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-2RELZYVZ.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
